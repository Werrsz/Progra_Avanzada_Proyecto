...
namespace LibreriaBazarProyecto.Controllers
{
    public class VentasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_venta,id_producto,cantidad,total")] Venta venta)
        {
            ...
            ViewBag.id_producto = new SelectList(db.Productos, "id_producto", "nombre_producto", venta.id_producto);
            return View(venta);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_venta,id_producto,cantidad,total")] Venta venta)
        {
            if (ModelState.IsValid)
            {
